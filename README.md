...
发布命名空间 / Thunderstore namespace: **AngelcoMilk**  
...
倍率含义：`0.4` 表示目标尺寸为原尺寸的 40%。v0.2.8 默认值：缩小速度 `0.9`，放大速度 `0.55`，离车防抖延迟 `2.5`，恢复后重新缩小冷却 `0.5`，商店/人物用品缩放 `false`。
...
Author: **AngelcoMilk**  
Thunderstore namespace: **AngelcoMilk**  
GitHub: https://github.com/AngelcoMilk/ShrinkCart  
Thunderstore: https://thunderstore.io/c/repo/p/AngelcoMilk/ShrinkCart/
...
Configuration is provided through REPOConfig. Scale factors are direct size multipliers: `0.4` means 40% of the original size. v0.2.8 defaults: shrink speed `0.9`, restore speed `0.55`, cart leave debounce `2.5`, post-restore reshrink cooldown `0.5`, shop/player item scaling `false`.
